...
class Programa (models.Model):
    NIVEL_FORMACION_CHOICES = [
        ...
        ('TEC', 'Técnico'),
        ('TGL', 'Tecnólogo'),
        ('ESP', 'Especialización Texcnológica'),
        ('COM', 'Complementaria'),
    ]
    ...
    perfil_egresado = models.TextField(verbose_name="Perfil de Egreso")
    requisitos_ingreso = models.CharField(verbose_name="Requisitos de Ingreso")
